...
<body onload="hasmsg()">
  ...
  <body>
    ...
    <div class="row">
      ...
      @else
      <div class="col s12 m12 l4" align="center"><a class="modal-trigger waves-effect waves-light btn-large z-depth-5 cyan darken-3" style="font-size:17px" href="#modal1"><i class="material-icons left">add_box</i>Add Host</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a class="modal-trigger waves-effect waves-light btn-large z-depth-5  blue-grey darken-1 disabled" style="font-size:17px" href="#modal2"><i class="material-icons left">library_add</i>Create Group</a></div>
      @endif
    </div>
    ...
    <div class="row">
      ...
      <div class="container" align="left">
        ...
        <div class="modal-footer">
          <a class="modal-action waves-effect waves-green btn teal" id="submitbtn">Add Host</a>
        </div>
      </div>
    </div>
