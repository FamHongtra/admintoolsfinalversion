      ...
      if($GLOBALS['test2'] == 1){
        ...
        if(count($repo_exist)==0){
          ...
          SSH::into('ansible')->run(array(
            ...
            "ansible -i /etc/ansible/users/$imp_token/hosts $servername -m shell -a 'git --git-dir=/home/$hostusr/vim/tmp_repo/$configkeygen/.git --work-tree=/home/$hostusr/vim/tmp_repo/$configkeygen/ config --global http.sslVerify false'",
